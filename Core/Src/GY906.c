...
#define SMBUS_SCK_H()        HAL_GPIO_WritePin(GY906_SCL_GPIO_Port,GY906_SCL_Pin,GPIO_PIN_SET)
#define SMBUS_SCK_L()        HAL_GPIO_WritePin(GY906_SCL_GPIO_Port,GY906_SCL_Pin,GPIO_PIN_RESET)
#define SMBUS_SDA_H()        HAL_GPIO_WritePin(GY906_SDA_GPIO_Port,GY906_SDA_Pin,GPIO_PIN_SET)
#define SMBUS_SDA_L()        HAL_GPIO_WritePin(GY906_SDA_GPIO_Port,GY906_SDA_Pin,GPIO_PIN_RESET)
#define SMBUS_SDA_PIN()	     HAL_GPIO_ReadPin(GY906_SDA_GPIO_Port,GY906_SDA_Pin) 
