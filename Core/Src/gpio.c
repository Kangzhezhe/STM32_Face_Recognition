...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOF, GY906_SDA_Pin|GY906_SCL_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, T_CS_Pin|T_SCK_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, RST_Pin|PWD_Pin|SCL_Pin|SDA_Pin, GPIO_PIN_SET);
  ...
  GPIO_InitStruct.Pin = GY906_SDA_Pin|GY906_SCL_Pin;
  ...
  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = MAX30102_SCL_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(MAX30102_SCL_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : PBPin PBPin */
  GPIO_InitStruct.Pin = RST_Pin|PWD_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
